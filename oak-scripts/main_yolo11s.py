"""
Region-Based Object Counting — Luxonis OAK / OAK4 + YOLO11s (VisDrone)
=======================================================================

DepthAI v3 peripheral-mode entry point. See main_yolo11n.py for usage.

Note: on OAK (RVC2), 320×320 YOLO11s may exceed Myriad-X SHAVE memory.
...
DEFAULT_MODEL = HERE / "yolo11s.blob"
IMGSZ = 320
FAMILY = "yolo11"
