"""
Region-Based Object Counting — OpenMV AE3 + YOLO26s (VisDrone)
================================================================

Board  : OpenMV AE3 (Alif Ensemble E3, Ethos-U55 256-MAC NPU)
Model  : YOLO26s trained on VisDrone, INT8 quantised, Vela-compiled
Input  : 320×320 RGB565
Note   : YOLO26 is end-to-end (NMS-free).

Files required on the camera:
  - yolo26s_int8_vela.tflite   (Vela-compiled model)
  - labels.txt / region_counter.py
"""
...
MODEL_PATH = "yolo26s_int8_vela.tflite"
