"""
Region-Based Object Counting — OpenMV N6 + YOLO11s (VisDrone)
==============================================================

Board  : OpenMV N6 (STM32N6 800 MHz CM55, ST Neural-ART 600 GOPS NPU)
Model  : YOLO11s trained on VisDrone, INT8 quantised
Input  : 320×320 RGB565

Files required on the camera:
  - yolo11s_int8.tflite         (INT8 quantised model)
...
# ── Configuration ─────────────────────────────────────────────────────
MODEL_PATH = "yolo11s_int8.tflite"
LABELS_PATH = "labels.txt"
INPUT_SIZE = 320
MIN_SCORE = 0.35

# N6 with VGA — regions on 640×480 canvas
REGIONS = [
