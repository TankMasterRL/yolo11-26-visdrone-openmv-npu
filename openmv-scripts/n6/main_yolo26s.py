"""
Region-Based Object Counting — OpenMV N6 + YOLO26s (VisDrone)
==============================================================

Board  : OpenMV N6 (STM32N6 800 MHz CM55, ST Neural-ART 600 GOPS NPU)
Model  : YOLO26s trained on VisDrone, INT8 quantised
Input  : 320×320 RGB565
Note   : YOLO26 is native end-to-end (NMS-free) — best accuracy of
         the small-model variants.

Files required on the camera:
  - yolo26s_int8.tflite         (INT8 quantised model)
...
# ── Configuration ─────────────────────────────────────────────────────
MODEL_PATH = "yolo26s_int8.tflite"
